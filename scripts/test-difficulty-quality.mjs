...
ok(app.includes("const APP_VERSION = '1.6.0';"),'Phase 13 app version missing');
ok(app.includes("const BUILD_PHASE = 'Difficulty Calibration & Puzzle Quality';"),'Phase 13 build identity missing');
